...
class PurchasesScreen:
    ...
    def open_edit_dialog(self, purchase_id):
        ...
        if purchase:
            ...
            # Estructura CORRECTA de la tupla de purchases (desde database.py):
            # purchase[0] = id
            # purchase[1] = material_id
            # purchase[2] = quantity
            # purchase[3] = total_price
            # purchase[4] = purchase_date
            # purchase[5] = supplier
            # purchase[6] = user_id
            
            material_id = purchase[1]   # ← CORREGIDO: índice 1
            current_quantity = purchase[2]   # ← CORREGIDO: índice 2
            current_total_price = purchase[3]   # ← CORREGIDO: índice 3
            current_supplier = purchase[5] if purchase[5] else ""   # ← CORREGIDO: índice 5
            ...
            # Obtener el nombre y precio unitario del material
